...
//Формируем тестовый запрос:
    $stmt =$pdo->prepare ("SELECT  books.nameBook, books.author_id, authors.name, books.genre_id, books.description, genres.nameGenre, books.year, books.image
FROM books
...
$stmt =$pdo->prepare ("SELECT  books.nameBook, books.author_id, books.genre_id, authors.name,  books.description, genres.nameGenre, books.year, books.image
FROM books
INNER JOIN authors ON authors.author_id=books.author_id
INNER JOIN genres ON genres.genre_id=books.genre_id
WHERE authors.author_id = ?
...
{include 'config.php';
$stmt = $pdo->prepare  ("SELECT  books.nameBook, authors.name, books.genre_id, genres.descriptionGenre, authors.author_id, books.description, genres.nameGenre, books.year, books.image
FROM books
INNER JOIN authors ON authors.author_id=books.author_id
INNER JOIN genres ON genres.genre_id=books.genre_id
WHERE genres.genre_id = ?
