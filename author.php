                ...
                <div class="card-list">
                    <div class="row card-item mb-4 pb-4 border-bottom">
                        ...
                        <div class="col-md-9">
                            ...
                            <h6>Автор: <a
                                        href="/author?id=<?= $booksAuthorId['author_id']; ?>"> <?= $booksAuthorId['name']; ?> </a>
                            </h6>
                            <p><?= truncate_string($booksAuthorId['description'], 480); ?></p>
                            <p class="text-small"><span
                                        class="font-weight-bold">год издания:</span> <?= $booksAuthorId['year']; ?></p>
                            <p class="text-small"><span class="font-weight-bold">жанр:</span><a
                                        href="/genre?id=<?= $booksAuthorId['genre_id']; ?>"> <?= $booksAuthorId['nameGenre']; ?></a>
                            </p>
                        </div>
                    </div>
                </div>
